...
public class Task1 {
    public static void main(String[] args) {
        ...
        user2.sendMessage(user1, "I'm fine! What are about you?");
        ...
        user1.sendMessage(user3, "Let is me up. Are you free tomorrow?");

        user3.sendMessage(user1, "Yep. I am free tomorrow! Let's go!");
